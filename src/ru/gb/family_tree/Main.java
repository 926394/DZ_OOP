...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        familyTree.add(new FamilyMember("Evgeniya", "woman", LocalDate.of(1891,5,2),
                LocalDate.of(2010,5,2),
                familyTree.getByName(null),familyTree.getByName(null)));

        familyTree.add(new FamilyMember("Vasilii", "man", LocalDate.of(1966,8,26),
                familyTree.getByName(null), familyTree.getByName(null)));

        familyTree.add(new FamilyMember("Tamara", "woman", LocalDate.of(1972, 5, 24),
                familyTree.getByName("Evgeniya"), familyTree.getByName(null)));

        familyTree.add(new FamilyMember("Nikolay", "man", LocalDate.of(1991,7,21),
                familyTree.getByName("Vasilii"), familyTree.getByName("Tamara")));

        familyTree.add(new FamilyMember("Angelina", "woman", LocalDate.of(1995, 4, 22),
                familyTree.getByName("Vasilii"), familyTree.getByName("Tamara")));
